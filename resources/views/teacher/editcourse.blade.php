      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
             ...
             <form action="{{ route('instructor.update.course', $course) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                      ...
                      <button type="button" class="btn btn-warning btn-sm mt-2" data-bs-toggle="modal" data-bs-target="#viewPhotoModal">
                          View Photo
                      </button>
                      @endif
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewPhotoModalLabel">Course Cover Photo</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-center">
                    <img src="{{ asset($course->photo_link) }}" alt="Course Photo" class="img-fluid rounded">
                </div>
            </div>
        </div>
    </div>
