          ...
          <div class="card-body">
            ...
            <table class="table datatable table-hover">
              ...
              <tbody>
                ...
                <tr>
                 <td> {{ $index + 1 }} </td>
                  <td> <a href="{{ route('admin.list.course', $course)}}"> {{ $course->title }} </a></td>
                  ...
                  <td>
                    <a href="{{ route('admin.edit.course', $course) }}" class="btn btn-sm bg-warning"><i class="bi bi-pencil-square text-white"></i></a>
